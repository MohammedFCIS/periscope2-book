...
One of the best methods to describe numerical feature measure tendency and dispersion is **Boxplot**. It shows median, quartiles, minimum, maximum, and outlier values in the same plot easily, these info can be displayed via plot tooltip upon hovering on the box, review @fig-2_10
