...
![Absolute Frequencies](Images/2_3_a_bar_plot.png){#fig-2_7a width=48%}

![Relative Frequencies](Images/2_3_b_bar_plot.png){#fig-2_7b width=48%}

![Absolute Stacked Frequencies](Images/2_3_c_bar_plot.png){#fig-2_7c width=48%}

![Relative Stacked Frequencies](Images/2_3_d_bar_plot.png){#fig-2_d width=48%}
...
The following are histogram examples, review @fig-2_8
...
The following are density plot examples, review @fig-2_9
